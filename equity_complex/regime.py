"""
Continuous regime characterization for the equity within-complex basket.
Anchored on SPX positive (risk-on direction).
"""
...
EXP_VAR_THRESHOLD = 0.65
PERSISTENCE_THRESHOLD = 0.85


LEADER_COLOR = {
    "SPX": "#3b82f6",  # blue
    "SPW": "#06b6d4",  # cyan (breadth-led)
    "VIX": "#f97316",  # orange (vol-led)
}
...
__REGIME_VERSION__ = "equity-v1.0-2026-05-09"
