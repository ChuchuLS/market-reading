"""
Continuous regime characterization for the commodities within-complex basket.
Anchored on BCOM positive (broad commodity-up direction).
"""
...
EXP_VAR_THRESHOLD = 0.45  # 5 assets — same as FICC main view
PERSISTENCE_THRESHOLD = 0.85


LEADER_COLOR = {
    "BCOM": "#3b82f6",  # blue (broad)
    "CL1": "#f97316",  # orange (energy)
    "HG1": "#a855f7",  # purple (industrial metals — growth)
    "GC1": "#facc15",  # yellow (gold — fear)
    "S1": "#06b6d4",  # cyan (ags)
}
...
__REGIME_VERSION__ = "comdty-v1.0-2026-05-09"
