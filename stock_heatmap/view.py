...
def render_stock_heatmap():
    ...
    if needs_load:
        st.info(
            f"Click **Load / Refresh data** to fetch {index_name} from Yahoo Finance. "
            "First load takes 30-90 seconds (especially S&P 500). Subsequent loads "
            "use cached data and are nearly instant."
        )
        return
